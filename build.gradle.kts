...
dependencies {
    ...
    //implementation("com.acmerobotics:roadrunner-core:0.10.2")
    implementation("com.acmerobotics.roadrunner:MeepMeep:0.1.7")
    //implementation("com.acmerobotics:roadrunner-trajectory-sequence:0.10.2")


    // MeepMeep
    //implementation("com.noahbres:meepmeep-core:2025.0.0") // adjust if using different version
